                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0);" class="btn btn-info waves-effect" onclick="">
                                                <i class="material-icons">visibility</i>
                                            </a>
                                            <a class="btn btn-danger" onclick="deleteFavorite({{ $post->id }});">
                                                <i class="material-icons">delete</i>
                                            </a>
                                            <form action="{{ route('author.remove.favorite.post', $post->id) }}" id="delete-favorite-{{ $post->id }}" method="POST">
                                                @csrf
                                            </form>
                                        </td>
                                    </tr>
